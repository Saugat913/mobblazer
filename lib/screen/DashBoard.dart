          ...
          children: [
            ...
            Center(
              child: Container(
                ...
                child: Row(children: [
                  Text("BUSINESS",style: TextStyle(color: Colors.white,fontSize: 19),),
                 Spacer(),
                 Text("${noOfBusiness}",style: TextStyle(color:Colors.white,fontSize: 32),),
                 SizedBox(width: 24,)
                ],),
              ),
            ),
            ...
            Center(
              child: Container(
               ...
               child: Row(children: [
                 ...
                 Spacer(),
                 Text("${noOfLocations}",style: TextStyle(fontSize: 32),),
                 SizedBox(width: 24,)
                ],),
              ),
            ),
